...
We checked which months are most dangerous.
...
Tersten sıralayalım.yaz sezonu artıyor.Datada month kolonu 0 olan satirlarin da oldugunu bu tablodan görmüs olduk.
...
[Interactive Data Map]( https://sevgilit.shinyapps.io/sevgilit/)


<center><div style="width:1000px; height=900px">![](D:/Users/tkartalkaya/Desktop/R Scripts/GTD/Shiny.PNG)</div></center>

```{r,eval=FALSE}
<center><div style="width:1000px; height=900px">![](https://github.com/MEF-BDA503/gpj-datING_/blob/master/GTD/Shiny.PNG)</div></center>
```
